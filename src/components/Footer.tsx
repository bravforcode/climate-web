...
export const Footer: React.FC = () => {
  return (
    <footer className="border-t border-white/10 bg-obsidian-950 mt-16 pt-12 pb-16 text-slate-400 text-xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Statutory Draft Disclosure Alert Box (CRITICAL COMPLIANCE) */}
        <div className="mb-10 p-5 rounded-2xl bg-obsidian-900/90 border border-white/10">
            ...
            <ul className="space-y-1.5 text-[11px]">
              <li>
                <a 
                  ...
                  target="_blank" 
                  rel="noreferrer" 
                  className="hover:text-climate-400 transition-colors flex items-center gap-1"
                >
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-1.5 text-[11px] text-slate-400">
              <li className="flex items-center gap-1.5">
                <CheckCircle2 className="w-3 h-3 text-climate-400" />
        ...
        {/* Bottom Bar */}
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-slate-500 font-mono">
          <div>
          ...
          <div className="flex items-center gap-4">
            ...
            <span>·</span>
            <span className="text-climate-400">Node: Local Pilot (Padung Krung Kasem)</span>
          </div>
        </div>
