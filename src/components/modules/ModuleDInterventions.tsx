...
export const ModuleDInterventions: React.FC<ModuleDProps> = ({
  ...
  const filteredInterventions = activeCategory === 'all'
    ? MOCK_INTERVENTIONS
    : MOCK_INTERVENTIONS.filter((item) => item.category === activeCategory);
            ...
            return (
              <div
                ...
                className={`p-3.5 rounded-2xl border transition-all cursor-pointer ${
                  isSelected
                    ? 'bg-teal-950/40 border-teal-500/50 shadow-glow-teal'
              ...
              >
                ...
                {/* Specs pill row */}
                <div className="mt-2.5 pt-2 border-t border-white/5 flex flex-wrap items-center justify-between gap-2 text-[10px] font-mono text-slate-400">
